...
# Introduction
In this tutorial, we will explore the percentage-change approach to clinical significance using R. This approach is commonly used in clinical research to assess the meaningfulness of change in patient outcomes. We will be working with the `claus_2020` dataset and the `cs_percentage()` function to demonstrate various aspects of these approaches.
...
First, let's have a look at the `antidepressnats` and `claus_2020` dataset, which come with the package.
