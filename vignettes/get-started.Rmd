...
We can see that BDI-II scores seemed to be declining over the course of treatment. 

<!-- A significance test indicates a significant reduction of BDI-II scores from pre (time = 1) to post treatment (time = 4). -->
